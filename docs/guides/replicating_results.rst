...
Depending on the synthetic data generation method a separate Python environment is needed. The instructions for installing the required environment for each method are provided in the installation guide.
