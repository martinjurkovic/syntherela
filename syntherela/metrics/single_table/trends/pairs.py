...
Based on https://github.com/sdv-dev/SDMetrics/blob/main/sdmetrics/reports/
multi_table_report/quality_report.py.
"""
...
class ColumnPairsReport(BaseMultiTableReport):
    ...
    column pair trends for all of the tables in the dataset.
    """
