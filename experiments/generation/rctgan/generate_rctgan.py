...
def remove_sdv_columns(tables, metadata, update_metadata=True):
    """Remove the columns added in SDV demo datasets.
    The relational demo datasets in SDV can have some columns  that are not
    present in the original datasets. This function removes these columns from
    the tables and the metadata.
    """
