...
def reproduce_figure(tables, tables_synthetic, metadata, target_table, feature, figure_name):
    # Compute the metric
    ...
    plt.savefig(f'results/figures/figure6{figure_name}.png', bbox_inches='tight', dpi=600)
