...
def reproduce_figure(tables, tables_synthetic, metadata, target_table, feature,
                     figure_name):
    # Compute the metric
    ...
    for table in tables.keys():
        tables_synthetic[table] = tables_synthetic[table][
    ...
    plt.savefig(f"results/figures/figure4{figure_name}.png",
                bbox_inches="tight",
                dpi=600)
